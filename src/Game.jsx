	...
	return (
		<div className="w-full h-screen bg-zinc-900 text-gray-300">
			...
			<div className="max-w-[1000px] mx-auto p-4 flex-flex-col justify-center w-full h-full">
				...
				<div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-8 text-center py-8 hover:cursor-pointer">
					<div className="w-54 h-16 boxshadow rounded-md hover:scale-110 duration-500">
